...
export interface MathProps extends ImageProps {
  type: string
...
export interface MathElement extends Image, CommenElement {
  type: string
  mathExpression: string
  mathColor?: string
  mathFontSize?: number
...
export type CanvasElement = TextboxElement | LineElement | QRCodeElement | BarCodeElement | MathElement | ImageElement | PathElement | GroupElement | PolygonElement | RectElement