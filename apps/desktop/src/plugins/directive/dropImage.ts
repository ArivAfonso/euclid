...
// import axios from 'axios'; // Make sure you have installed and imported axios
...
const defaultUpload = async (files: FileList, uploadUrl: string): Promise<void> => {
  ...
  Array.from(files).forEach(async (file) => {
    ...
    //   })
    //     .then((response) => {
    //       // You can trigger an event or call a callback here
    ...
    if (["jpg", "jpeg", "png", "webp", "gif"].includes(curFileSuffix as string)) {
