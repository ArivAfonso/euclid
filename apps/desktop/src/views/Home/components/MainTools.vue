<template>
  <div class="page-section-container mb-10" >
    <section>
      <div class="section-header">
        <h2 class="title-wrapper">Common Tools</h2>
      </div>
    ...
    <section>
      <div class="section-header">
        <h2 class="title-wrapper">Common Materials</h2>
      </div>
      <!-- Image TODO -->
  ...
  <div class="page-section-container">
    <section>
      <div class="section-header">
        <h2 class="title-wrapper">Editor's Picks</h2>
      </div>
      <div class="editor-recommend">
        <div>
          <div v-for="item in ['img1','img2','img3','img4']" :key="item">{{ item }}</div>
          <p>Daily - New Products</p>
        </div>
        <div>
          <div>img1</div>
          <div>img2</div>
    ...
    <section>
      <div class="section-header">
        <h2 class="title-wrapper">Hot Calendar</h2>
      </div>
