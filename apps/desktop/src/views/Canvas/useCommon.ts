...
export default () => {
  const initCommon = () => {
    ...
    const workSpaceClip = new Rect({
      ...
      stroke: WorkSpaceClipColor, // Border color
    ...
    const workSpaceSafe = new Rect({
      ...
      fill: TransparentFill,
      stroke: WorkSpaceSafeColor, // Border color
      strokeWidth: 1, // Border size
    ...
    // [lineEnd, lineHeight, leftStart, top] End position, line length, start position, top
